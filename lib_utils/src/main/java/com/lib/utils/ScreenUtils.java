...
public final class ScreenUtils {
    ...
    public static int getScreenWidth(@NonNull Context context) {
        WindowManager wm = (WindowManager) ActivityUtils.getApplicationContextOfContext(context).getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) return -1;
    ...
    public static boolean isLandscape(@NonNull Context context) {
        return ActivityUtils.getApplicationContextOfContext(context).getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock(@NonNull Context context) {
        KeyguardManager km =
                (KeyguardManager) ActivityUtils.getApplicationContextOfContext(context).getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(@NonNull Context context, final int duration) {
        Settings.System.putInt(
                ActivityUtils.getApplicationContextOfContext(context).getContentResolver(),
